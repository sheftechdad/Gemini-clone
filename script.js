...
const generateResponse = async (botMsgDiv) =>{
    ...
    chatHistory.push({
    role:"user",
    parts:[{text: userData.message}, ...(userData.file.data ? [{ inline_data: (({ fileName,
    isImage, ...rest}) => rest)(userData.file)}] :[])]
...
const handleFormSubmit = (e) => {
   ...
   ${userData.file.data ? (userData.file.isImage ? `<img src="data:${userData.file.mime_type};base64,
    ...
    class="material-symbol-round">description</span>${userData.file.fileName}</p>`) : ""}`;
